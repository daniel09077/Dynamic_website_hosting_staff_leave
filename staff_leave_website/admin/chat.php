...
<head>
	...
	<link rel="shortcut icon" href="<?php echo STATIC_URL; ?>vendors/images/logo.png" type="image/x-icon">
	<!-- Site favicon 
	...
	<!-- CSS -->
	<link rel="stylesheet" type="text/css" href="<?php echo STATIC_URL; ?>vendors/styles/core.css">
    <link rel="stylesheet" type="text/css" href="<?php echo STATIC_URL; ?>vendors/styles/icon-font.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo STATIC_URL; ?>src/plugins/jquery-steps/jquery.steps.css">
    <link rel="stylesheet" type="text/css" href="<?php echo STATIC_URL; ?>src/plugins/datatables/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo STATIC_URL; ?>src/plugins/datatables/css/responsive.bootstrap4.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo STATIC_URL; ?>vendors/styles/style.css">
...
<?php include('../includes/statfile_config.php'); ?>
				...
				<div class="dropdown">
					...
					<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						<span class="user-icon">
							<img src="<?php echo (!empty($row['location'])) ? STATIC_URL.'vendors/uploads/'.$row['location'] : STATIC_URL.'vendors/uploads/NO-IMAGE-AVAILABLE.jpg'; ?>" alt="">
						</span>
