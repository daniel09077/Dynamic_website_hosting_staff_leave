							...
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									...
									<div class="avatar mr-2 flex-shrink-0">
										<img src="<?php echo STATIC_URL; ?>vendors/signature/<?php echo $result->Sign; ?>" width="60" height="40" alt="">
									</div>
								</div>
							</div>
						</div>
						<div class="form-group row">
							<div class="col-md-6 col-sm-12">
							    <div class="form-group">
									...
									<?php else: ?>
									  <div class="avatar mr-2 flex-shrink-0">
										<img src="<?php echo STATIC_URL; ?>vendors/signature/<?php echo $result->HodSign; ?>" width="100" height="40" alt="">
									  </div>
									<?php endif ?>
							    </div>
							</div>
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									...
									<?php else: ?>
									  <div class="avatar mr-2 flex-shrink-0">
										<img src="<?php echo STATIC_URL; ?>vendors/signature/<?php echo $result->RegSign; ?>" width="100" height="40" alt="">
									  </div>
									<?php endif ?>
								</div>
							</div>
